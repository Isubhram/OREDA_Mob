			...
			>
				...
				<View style={styles.statsStrip}>
					<View style={styles.statChip}>
						...
						<Text style={styles.statChipText}>
							{tenders.filter((t) => !isExpired(t.TenderEndDate)).length} Active
						</Text>
					</View>
					<View style={styles.statChip}>
						<View style={[styles.statDot, { backgroundColor: '#ef4444' }]} />
						<Text style={styles.statChipText}>
							{tenders.filter((t) => isExpired(t.TenderEndDate)).length} Expired
						</Text>
					</View>
					<View style={styles.statChip}>
					...
					tenders.map((tender, index) => {
						...
						return (
							...
							>
								{/* Card accent bar */}
								<View
									style={[styles.cardAccent, { backgroundColor: expired ? '#ef4444' : '#10b981' }]}
								/>
									...
									<View style={styles.cardMetaRow}>
										<View style={styles.cardMeta}>
											...
											<Text style={styles.cardMetaValue}>
												{formatDate(tender.TenderStartDate)}
											</Text>
										</View>
				...
				{tenders.length > 0 && (
					<Text style={styles.footerText}>
						Showing {tenders.length} of {totalRecords} tenders
					</Text>
				)}
			</ScrollView>
		</SafeAreaView>
