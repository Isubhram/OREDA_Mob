...
import { View, Text, StyleSheet, SafeAreaView, ScrollView, Dimensions, TouchableOpacity, StatusBar } from 'react-native';
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.statsGrid}>
                        <QuickStat label="Projects"       value={stats.projects}   icon="briefcase-variant"    color="#3b82f6" onPress={() => navigation.navigate('Project')} />
                        <QuickStat label="Tenders"        value={stats.tenders}    icon="file-document-edit"   color="#f59e0b" onPress={() => navigation.navigate('Tender')} />
                        <QuickStat label="Work Orders"    value={stats.workOrders} icon="clipboard-check"      color="#10b981" onPress={() => navigation.navigate('WorkOrder')} />
                        <QuickStat label="Incidents"      value={stats.incidents}  icon="alert-octagon"        color="#ef4444" onPress={() => navigation.navigate('IncidentTicket')} />
                    </View>
                    ...
                    <View style={styles.actionGrid}>
                        ...
                        <TouchableOpacity style={styles.actionCard} onPress={() => navigation.navigate('IncidentTicket')}>
                    ...
                    <View style={styles.announcementCard}>
                        ...
                        <View style={styles.announcementContent}>
                            ...
                            <Text style={styles.announcementText}>New guidelines for rooftop solar projects have been uploaded to the portal center.</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
