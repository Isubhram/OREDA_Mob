...
const LoginScreen = () => {
	...
	const handleLogin = async () => {
		...
		if (!userId.trim()) {
			setErrors((prev) => ({
				...prev,
				userId: `${loginType === 'phone' ? 'Phone Number' : 'User ID'} is required.`,
			}));
			hasError = true;
		}
		...
		try {
			...
			if (error instanceof ApiError) {
				...
				setErrors((prev) => ({
					...prev,
					general: 'Something went wrong. Please check your internet connection.',
				}));
			}
		} finally {
			setIsLoading(false);
						...
						<ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
							<View style={styles.glassCard}>
								...
								<View style={styles.welcomeSection}>
									...
									<Text style={styles.instructionText}>Sign in to your account to continue</Text>
								</View>
								...
								<View style={styles.toggleContainer}>
									...
									>
										<Text
											style={[
												styles.toggleText,
												loginType === 'userId' && styles.activeToggleText,
											]}
										>
											Account Login
										</Text>
								...
								<View style={styles.formContainer}>
									<TextInput
										...
										placeholder={
											loginType === 'phone' ? 'Enter Your Phone Number' : 'Enter Your User ID'
										}
										value={userId}
										onChangeText={(text) => {
											setUserId(text);
										...
										<View style={styles.captchaCompactRow}>
											<View style={styles.captchaDisplayContainer}>
												...
												<TouchableOpacity
													...
													style={styles.refreshIconCompact}
												>
											...
											<View
												style={[
													styles.captchaInputContainerCompact,
													errors.captcha ? styles.inputError : null,
												]}
											>
												<TextInput
