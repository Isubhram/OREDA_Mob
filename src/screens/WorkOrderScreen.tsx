...
const WorkOrderScreen = ({ navigation }: any) => {
    ...
    const onRefresh = () => { setRefreshing(true); loadWorkOrders(); };
    ...
    const isOverdue = (completionDate: string) => {
        ...
        try { return new Date(completionDate) < new Date(); } catch { return false; }
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                {workOrders.length === 0 ? (
                    ...
                    workOrders.map((wo, index) => {
                        ...
                        return (
                            ...
                            >
                                <View style={[styles.cardAccent, { backgroundColor: overdue ? '#ef4444' : '#10b981' }]} />
                                <View style={styles.cardBody}>
                                    ...
                                    <View style={styles.cardTopRow}>
                                        ...
                                        <View style={[styles.statusBadge, { backgroundColor: overdue ? '#fee2e2' : '#dcfce7' }]}>
                                            <Text style={[styles.statusBadgeText, { color: overdue ? '#b91c1c' : '#15803d' }]}>
                                    ...
                                    {/* Project name */}
                                    <Text style={styles.cardProjectName} numberOfLines={2}>{wo.ProjectName}</Text>
                                    ...
                                    <View style={styles.cardMetaRow}>
                                        ...
                                        <View style={styles.cardMeta}>
                                            ...
                                            <Text style={[styles.cardMetaValue, overdue && { color: '#ef4444' }]}>{formatDate(wo.CompletionDueDate)}</Text>
                                        </View>
                                    </View>
                ...
                {workOrders.length > 0 && (
                    <Text style={styles.footerText}>Showing {workOrders.length} of {totalRecords} work orders</Text>
                )}
            </ScrollView>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    headerIconBox: { backgroundColor: '#10b981', width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
